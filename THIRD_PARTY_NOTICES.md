...
Internet Archive search uses the official Advanced Search and Metadata APIs without bundling third-party code or media. Audio remains hosted by Internet Archive and retains its item-specific rights metadata. Listener only enables attachment downloads when the item exposes a recognized Creative Commons or Public Domain license URL; it does not store or cache the audio.
