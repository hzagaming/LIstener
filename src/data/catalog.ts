...
export const playlists: Playlist[] = [
  {
    id: 'p1', title: '沿海公路', description: '风把心事吹向很远的地方', cover: 'coast', count: 28,
    tracks: tracks.slice(0, 5),
  },
  {
    id: 'p2', title: '下班后失踪', description: '把所有消息都设为免打扰', cover: 'afterwork', count: 36,
    tracks: [tracks[5], tracks[1], tracks[6], tracks[3]],
  },
  {
    id: 'p3', title: '卧室独立电台', description: '唱针落下，世界暂时静音', cover: 'radio', count: 42,
    tracks: [tracks[2], tracks[4], tracks[7]],
  },
  {
    id: 'p4', title: '雨天便利店', description: '凌晨两点还有一盏灯亮着', cover: 'rain', count: 31,
